            ...
            <div className="dashboard-page">
                ...
                <div className="dashboard-intro">
                    ...
                    <div>
                        ...
                        <p>
                            Real-time overview of transaction
                            risk, fraud activity and
                ...
                <div className="stats-grid">
                    ...
                    <div className="stat-card stat-purple">
                        ...
                        <div>
                            ...
                            <strong>
                                {dashboardStats.averageML.toFixed(1)}%
                            </strong>
                    ...
                    <div className="dashboard-card">
                        ...
                        <div className="card-heading">
                            ...
                            <div>
                                ...
                                <p>
                                    Most active merchants and
                                    associated fraud events.
                                </p>
                        ...
                        <div className="ml-dashboard-content">
                            ...
                            <div className="ml-progress-wrapper">
                                ...
                                <div className="ml-progress-header">
                                    ...
                                    <strong>
                                        {dashboardStats.mlCoverage.toFixed(1)}%
                                    </strong>
                ...
                <div className="dashboard-card recent-card">
                    ...
                    <div className="card-heading">
                        ...
                        <div>
                            ...
                            <p>
                                Latest activity from the
                                FraudShield-X transaction engine.
                            </p>
                    ...
                    <div className="transaction-form-modal">
                        ...
                        <div className="modal-header">
                            ...
                            <div>
                                ...
                                <p>
                                    Submit a transaction for
                                    rule-based and ML fraud analysis.
                                </p>
